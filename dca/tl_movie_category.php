 ...
 */
$GLOBALS['TL_DCA']['tl_movie_category'] = array
(
	...
	(
		...
		(
			...
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_movie_category']['copy'],
				'href'                => 'act=copy',
				'icon'                => 'copy.gif'
			),
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_movie_category']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_movie_category']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			)
		)
